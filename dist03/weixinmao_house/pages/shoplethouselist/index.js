...
Page({
    ...
    onLoad: function(t) {
        ...
        this.setData({
            ...
            title: "商铺门面出租-" + wx.getStorageSync("companyinfo").name
        });
    ...
    toHouseDetail: function(t) {
        ...
        wx.navigateTo({
            url: "/weixinmao_house/pages/shoplethousedetail/index?id=" + e
        });
    },
    toSearch: function(t) {
        wx.navigateTo({
    ...
    gethouselist: function(t) {
        ...
        app.util.request({
            url: "entry/wxapp/getshoplethouselist",
            data: {
                cityid: a,
                page: e.data.page,
    ...
    onShareAppMessage: function() {
        return {
            ...
            path: "/weixinmao_house/pages/shoplethouselist/index"
        };
    }
});