...
Page(_defineProperty({
    ...
    onLoad: function(a) {
        ...
        app.util.request({
            url: "entry/wxapp/getshophousedetail",
            data: {
                id: e
            },
            success: function(a) {
    ...
    toOldHouseDetail: function(a) {
        ...
        wx.navigateTo({
            url: "/weixinmao_house/pages/shophousedetail/index?id=" + t
        });
    },
    ...
    return console.log(this.data.id), {
        ...
        path: "/weixinmao_house/pages/shophousedetail/index?id=" + this.data.id
    };
}));