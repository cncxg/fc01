...
Page({
    ...
    onShow: function() {
        ...
        wx.setNavigationBarTitle({
            title: "商铺门面出售-" + wx.getStorageSync("companyinfo").name
        });
        this.setData({
            housetypelist: [ {
                name: "住宅",
    ...
    toHouseDetail: function(t) {
        ...
        wx.navigateTo({
            url: "/weixinmao_house/pages/shophousedetail/index?id=" + e
        });
    },
    toSearch: function(t) {
        wx.navigateTo({
    ...
    gethouselist: function(t) {
        ...
        app.util.request({
            url: "entry/wxapp/getshophouselist",
            data: {
                cityid: a,
                page: e.data.page,
    ...
    onShareAppMessage: function() {
        return {
            ...
            path: "/weixinmao_house/pages/shophouselist/index"
        };
    }
});