...
Page((_defineProperty(_Page = {
    ...
    toletHouseDetail: function(a) {
        ...
        wx.navigateTo({
            url: "/weixinmao_house/pages/shoplethousedetail/index?id=" + t
        });
    },
    ...
    getlethousedetail: function() {
        ...
        app.util.request({
            url: "entry/wxapp/getshoplethousedetail",
            data: e,
            success: function(a) {
    ...
    return {
        ...
        path: "/weixinmao_house/pages/shoplethousedetail/index?id=" + this.data.id
    };
